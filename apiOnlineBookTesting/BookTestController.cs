...
namespace apiOnlineBookTesting
{
    public class BookTestController
    {
        ...
        public static DbContextOptions<ApiDbContext> dbContextOptions { get; set; }
        ...
        {
            dbContextOptions = new DbContextOptionsBuilder<ApiDbContext>().UseSqlServer(connectionString).Options;
        }
        public BookTestController()
        {
            context = new ApiDbContext(dbContextOptions);
        }
        ...
        public async void Task_GetBookById_Return_MatchedData()
        {
            ...
            Assert.Equal("Everything Happens", book.BookName);
